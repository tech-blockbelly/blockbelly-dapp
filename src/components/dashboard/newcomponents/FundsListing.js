...
const Indices = [
    {
        ...
        creator: 'DeFi Pulse',
        creator_icon:
            'https://set-core.s3.amazonaws.com/img/social_traders/defi_pulse.png',
        allocations: {
            CWBTC: '98.13%',
            USDC: '1.87%',
        },
    },
    {
        ...
        creator: 'Meta Portal',
        creator_icon:
            'https://set-core.s3.amazonaws.com/img/social_traders/MetaPortal.png',
        allocations: {
            ILV: '19.13%',
            SAND: '29.89%',
            Axie: '26.41%',
    ...
    },
    {
        ...
        creator: 'Bankless HQ',
        creator_icon:
            'https://raw.githubusercontent.com/SetProtocol/uniswap-tokenlist/main/assets/managers/bankless_logo.jpeg',
        allocations: {
            BTC: '19.13%',
            ETH: '29.89%',
            DPI: '46.41%',
...
const FundsListing = (props) => {
    ...
    const onFundSelect = (eventId) => {
        const index = Indices[eventId];
        setEventKey(index['link']);
        setEventId(eventId);
        setShowPage(true);
    };
