...
//   const { registry } = props;
  ...
  const registryInterface = new utils.Interface(Broker.abi);
  const registryContractAddress = "0x010beF225D0DEAF8fB429726198ff997485f9b0d";
  const contract = new Contract(registryContractAddress, registryInterface);
            ...
            <ListGroup className="funds-list-group">
              <ListGroup.Item className="sort-button-container">
                <Row>
                  ...
                  <Col xl={2} className="text-center">
                    <a>
                      {props.toLedger ? "Amt. Invested" : "Min. Amount"}
                      <FaSort />
                    </a>
                  </Col>
                  <Col xl={2} className="text-center">
            ...
            <ListGroup className="funds-list-group">
              ...
              <ListGroup.Item className="sort-button-container">
                <div className="no-selection text-center">
                  <Button className="btn m-auto" onClick={linkExchange}>
                    Explore Funds
                  </Button>
                </div>
              </ListGroup.Item>
