        ...
        <div
            ...
            <Table responsive className="ccy-table">
                <thead className="ccy-header-container">
                    <tr>
                        <th className="ccy-header"><h5>Name</h5></th>
                        <th className="ccy-header"><h5>Allocation</h5></th>
                        <th className="ccy-header"><h5>Last Price (USD)</h5></th>
                        <th className="ccy-header"><h5>Symbol</h5></th>
                        <th className="ccy-header"><h5>Amount (Coin)</h5></th>
                        <th className="ccy-header"><h5>Price (USD)</h5></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td colSpan={4}>
                            <p className="ccy-header text-right">Platform Fees (USD)</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colSpan={4}>
                            <p className="ccy-header text-right">Manager Fees (USD)</p>
                        </td>
                        <td>
